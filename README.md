...
If you choose to work on this project disconnected from Qualified, run npm install to install the project and run git init to initialize a git repository.
Running tests
